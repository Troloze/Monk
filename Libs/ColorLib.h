...
#define mergeAlpha(a,b) ((((Uint8)(255 * ((((a & 0xFF000000) >> (3*8))/255.0) + (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0))))) << 3 * 8)) | (((Uint8)(255 * ((((((a & 0xFF0000) >> (2*8))/255.0) * ((((a & 0xFF000000) >> (3*8))/255.0))) + ((((b & 0xFF0000) >> (2*8))/255.0) * (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0)))) / ((((a & 0xFF000000) >> (3*8))/255.0) + (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0)))))) << 2 * 8) | (((Uint8)(255 * ((((((a & 0xFF00) >> (8))/255.0) * ((((a & 0xFF000000) >> (3*8))/255.0))) + ((((b & 0xFF00) >> (8))/255.0) * (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0)))) / ((((a & 0xFF000000) >> (3*8))/255.0) + (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0)))))) << 8) | ((Uint8) (255 * ((((((a & 0xFF))/255.0) * ((((a & 0xFF000000) >> (3*8))/255.0))) + ((((b & 0xFF))/255.0) * (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0)))) / ((((a & 0xFF000000) >> (3*8))/255.0) + (((b & 0xFF000000) >> (3*8))/255.0) * (1 - (((a & 0xFF000000) >> (3*8))/255.0))))))
